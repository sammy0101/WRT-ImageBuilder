...
Generated on: Fri Sep 25 15:19:21 UTC 2026
...
#!/usr/bin/env python3
"""
同步官方最新設備資料庫並自動注入改寫 build-firmware.yml 的下拉選單
"""
import json
import re
...
def main():
    ...
    for pid, info in upstream.items():
        ...
        if any(brand in vendor_lower for brand in ["xiaomi", "redmi", "gl.inet", "friendlyarm", "raspberry", "asus", "tplink"]):
    ...
    # 2. 自動將所有設備組裝為 YAML options 格式並注入 build-firmware.yml
    if WORKFLOW_PATH.exists():
        ...
        # 精確匹配 # --- AUTO_DEVICES_START --- 與 # --- AUTO_DEVICES_END --- 之間的內容
        ...
        print("✓ build-firmware.yml 下拉選單已全自動注入完成！")
